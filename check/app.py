...
# ================== UI ==================
st.markdown('<div class="main-header"><h1>IntelliFlow</h1><p>AI-driven market, demand & product feasibility analysis powered by multi-agent systems</p></div>', unsafe_allow_html=True)
...
"""
        try:
            ...
            try:
                ...
                ai_text = f"Error: Both Ollama and Groq failed.\n\nDetails: {e}"
...
<div style='text-align: center; color: #666; padding: 2rem;'>
    <p>Powered by Multi-Agent AI Systems | Ollama llama3:latest | DuckDuckGo | Jina AI</p>
